...
private:
  ...
  enum MenuId : uint8_t { MENU_MAIN, MENU_PRINT, MENU_MOTION, MENU_TEMPS, MENU_MACROS, MENU_FILES, MENU_SYSTEM, MENU_CONTROLS, MENU_SETTINGS };
  enum PageId : uint8_t { PAGE_MENU, PAGE_STATUS, PAGE_PRINT_STATUS, PAGE_MOTION, PAGE_TEMPS, PAGE_SYSTEM };
